...
#### 判定父节点是否为类型容器（决定符号记为 `method` 还是 `function`）的 kind 集合 [@380kkm 2026-06-05] ####
_JAVA_TYPE_KINDS = frozenset(("class", "interface", "enum"))


#### 收集 `superclass` 和 `interfaces` 节点下的类型标识符文本 [@380kkm 2026-06-05] ####
...
#### 递归遍历 Java 语法树，收集类型符号、方法符号与继承边 [@380kkm 2026-06-05] ####
