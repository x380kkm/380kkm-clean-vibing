...
# ///
# audience: internal
# cleanscan.lib.boundary.nodes
"""cleanscan.lib.boundary.nodes —— 图节点与限定名的构造。

为已索引的符号构造图 :class:`~lib.graph.Node`，为未解析或依赖的外部符号构造外部节点，
...
#### 为依赖或未解析符号构造外部节点（id 为 dep:<name>） [@380kkm 2026-06-05] ####
