...
(function(){
  ...
  // loaded slice — a deeper/fresh chain = re-run cleanscan with that node as the seed.
  ...
  function buildChild(root){
    ...
    var banner = '<div style="position:fixed;top:44px;left:0;right:0;z-index:9;'
      ...
      + ' (this slice only \u2014 re-run cleanscan for a deeper chain)</div>';
  ...
  function exportHidden(){
    ...
    try{ var a=document.createElement('a');                                          // (c) Blob download
      ...
      a.download='cleanread.view_hide.json'; a.click(); }catch(_){}
  }
